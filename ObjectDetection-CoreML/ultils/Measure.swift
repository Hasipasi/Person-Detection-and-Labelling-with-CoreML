...
class Measure {
    ...
    func start_measure() {
        ...
        label_measure(for: index, with: "start")
    }
    
    // stop
    func stop_measure() {
        label_measure(for: index, with: "end")
    ...
    // labeling with
    func label_measure(with msg: String? = "") {
        label_measure(for: index, with: msg)
    }
    
    private func label_measure(for index: Int, with msg: String? = "") {
        if let message = msg {
